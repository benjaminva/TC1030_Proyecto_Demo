...
class Asalariado: public Empleado {
  ...
  Asalariado(int id, string nombre, double salar): Empleado(id, nombre, "asalariado"),
...
class PorHora: public Empleado {
  ...
  PorHora(int id, string nombre, double horas, double pago): Empleado(id, nombre, "por hora"),
  horas_t(horas),
  pago_por_h(pago) {};
...
class Practicante: public Empleado {
  ...
  Practicante(int id, string nombre, double horas, double pago): Empleado(id, nombre, "practicante"),
  horas_t(horas),
  pago_p(pago) {};
